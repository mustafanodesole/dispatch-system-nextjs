...
const ImmediateResponseForm = ({ onSubmit }) => {
    ...
    return (
        <form className="max-w-[80%] mx-auto p-5 bg-white rounded-lg shadow-lg" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Select
                    ...
                    classNames={{ mainWrapper: '!bg-white border-2 border-gray-300 p-2 rounded-md', trigger: '!bg-white' }}
            ...
            <Button className='mt-5 text-sm bg-[#2D8076] text-white' size='sm' type="submit" >
                Immediate Response
            </Button>
            </div>
        </form>
